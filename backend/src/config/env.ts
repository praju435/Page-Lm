...
export const config = {
  ...
  gemini: process.env.gemini || process.env.GOOGLE_API_KEY || process.env.GEMINI_API_KEY || 'AIzaSyB_bYPq9JVP5q0In1uAwbeTEr9vJ-70h3Q',
  gemini_model: process.env.gemini_model || process.env.GEMINI_MODEL || 'gemini-2.5-flash',
  gemini_embed_model: process.env.gemini_embed_model || process.env.GEMINI_EMBED_MODEL || 'models/text-embedding-004',
